...
https://polarion.engineering.redhat.com/polarion/#/project/OpenShiftContainerStorage/workitem?id=OCS-294

1) Create a Storage Class
2) Create a PVC (if the pvc is created then storage class is successfully deployed.)
